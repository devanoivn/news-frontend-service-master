...
<body class="bg-body-tertiary">
    ...
    <main class="container">
        <div class="d-flex align-items-center p-3 my-3 text-white bg-purple rounded shadow-sm">
            ...
            <img class="me-3" src="isiberita" alt="" width="48"
                height="38">
            <div class="lh-1">
                <h1 class="h6 mb-0 text-white lh-1">Binews</h1>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="d-flex text-body-secondary pt-3">
                ...
                <div class="pb-3 mb-0 small lh-sm border-bottom w-100">
                    <div class="d-flex justify-content-between">
                        <strong class="text-gray-dark">Nama Berita</strong>
                        <a href="#">Remove</a>
                    </div>
            ...
            <div class="d-flex text-body-secondary pt-3">
                ...
                <div class="pb-3 mb-0 small lh-sm border-bottom w-100">
                    <div class="d-flex justify-content-between">
                        <strong class="text-gray-dark  justify-content-between">Nama Berita</strong>
                        <a href="#">Remove</a>
                    </div>
                    <span class="d-block">Desc</span>
                </div>
